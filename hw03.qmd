...
p1.save("figure_2_1_3_1.png", dpi=150, verbose=False)
# 사진 파일로 저장했다가 진행하지 않으면 html에 보이지 않는 문제가 발생하여 이런 방식 채택. 
...
p2.save("figure_2_1_3_2.png", dpi=150, verbose=False)
```
:::
...
출력된 warning으로부터 조금 더 구체적으로 추측해보면, $\theta$의 추정치가 수렴하지 못하고 계속 변화하다가 boundary인 0을 넘어가게 되어 추정치가 0에서 truncate되는 문제가 발생했고, 그러면서 가능도 계산 등에서 NaN 같은 문제가 생겼을 것이다. Python의 경우에도 비슷한 종류의 warning과 error가 발생한다.  
...
![workflow 종료 확인](./problem3_images/problem3_3_1.png)

![URL 확인](./problem3_images/problem3_3_2.png)

![브라우저 작동 확인](./problem3_images/problem3_3_3.png)

![html 링크 작동 확인](./problem3_images/problem3_3_4.png)

![ipynb 링크 작동 확인](./problem3_images/problem3_3_5.png)
